odoo.define('dynamic_odoo.ReportEdit', function (require) {
    ...
    var ReportContent = baseEdit.ViewContent.extend({
        ...
        init: function (parent, params) {
            ...
            this.helperInfo = {
                ...
                column: {
                    ...
                    tag: "th, td",
                    selector: "table.o_main_table th, table.table-sm th, table.table-condensed, td",
                    add: this.addColumns,
                },
                hr: {
        ...
        addColumns: async function (el, node, position = "before") {
            ...
            this._onShowChooseField(el, onChange, chain, true);
        },
        ...
        _onShowChooseField: function (el, onChange, value = [], needCheckTD=false) {
            const onClose = () => {
                delete this.keepHolder;
                this.removeHelper();
            }
            ...
            const chooseFieldDialog = new basic_widgets.ChooseFieldDialog(this, {
                name: "choose_field",
                fields: this.getDataValues(needCheckTD ? $('td.columnsHelper').eq(0) : el),
                onChange: _onChange,
                onClose: onClose,
                value: value,
            });
