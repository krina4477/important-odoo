        ...
        # step 2 increaset product qty by 1 if product not in order line than create new order line.
            ...
            if search_lines:
                ...
                if search_product:
                    ...
                    if obj_price_stand:
                        set_price_stand = search_product.standard_price
                    else:
                        set_price_stand = search_product.standard_price
                    ...
                    order_line_val = {
                        ...
                        'is_warehouse': True,
                        'warehouses_id':search_product.purchase_warehouse_id.id,
                    ...
                    set_price = 0.0
                    if search_product_code.price_lst:
                        ...
                        if obj_price:
                            set_price = search_product_code.product_id.standard_price
                        else:
                            set_price = search_product_code.product_id.standard_price
                    else:
                        set_price = search_product_code.product_id.standard_price
                    ...
                    if search_lines_code:
                        search_lines_code.sudo().write({"product_qty": search_lines_code.product_qty + 1
                                                        ,
                        "sh_purchase_barcode_scanner_is_last_scanned": is_last_scanned,
                        "sequence" : sequence,
                        ...
                        vals = {
                            ...
                            'is_warehouse': True,
                             "date_planned": str(fields.Date.today()),
                            'warehouses_id':search_product_code.product_id.purchase_warehouse_id.id,
                            'sh_purchase_barcode_scanner_is_last_scanned': is_last_scanned,
                            'sequence': sequence,
                        }
