...
16.0.1.0 ==> 
@Fix:-
 - In the Sales Analysis it will show only the allowed banch analysis in the graph and pivot view
 - Invoicing -> Bill-> form view -> Branch automatically filed.
 - Inventory-> Operations-> Transforms -> filter with branch it shows the allowed branch only.

Date 20/03/2024
16.0.1.1 ==> 
@Fix:-
 - When we select Multiple branch at that time it shows all the selected branch's SO record.

Date 10/04/2024
16.0.1.2 ==>
@Fix:-
 - Solve the issue of multi-company compatibility with multi-branch.

 => 16.0.1.3 :- Date 17 Jul 2024
:- Fixed the issue of multi-branch not appearing correctly in sale orders.

 => 16.0.1.4 :- Date 26 Jul 2024
:- Added functionality to display records based on branches such as sale, purchase, products, and customers.