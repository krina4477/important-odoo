...
class OrderReturn(models.Model):
    ...
    request_date = fields.Datetime("Return Request On")
    ...
    def _prepare_base_line_for_taxes_computation(self, **kwargs):
        ...
        return self.env['account.tax']._prepare_base_line_for_taxes_computation(
            ...
            **{
                ...
                'currency_id': self.return_order_id.website_order_id.currency_id or self.website_order_id.company_id.currency_id,
        ...
        if self and self._context and self._context.get('return_mode', False):
            ...
            if move_quant_dict:
                return {
                    ...
                    'quantity': move_quant_dict[stock_move.id],
