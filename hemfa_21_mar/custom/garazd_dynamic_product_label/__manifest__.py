...
{
    'name': 'Custom Dynamic Product Labels',
    'version': '16.0.2.0.0',
    ...
    'depends': [
        'product','garazd_product_label','garazd_product_label_pro','hemfa_dynamic_product','stock'
    ],
    'data': [
        ...
        'wizard2/print_product_label_views_inhert.xml',
    ],
    'demo': [
