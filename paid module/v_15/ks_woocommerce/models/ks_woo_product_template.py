...
class KsWooProductTemplate(models.Model):
    ...
    ks_company_id = fields.Many2one('res.company', string="Company", default=lambda self: self.ks_wc_instance.ks_company_id.id,
    ...
    def ks_manage_woo_product_template_import(self, instance, product_json_data,odoo_main_product=False, queue_record=False):
        """
