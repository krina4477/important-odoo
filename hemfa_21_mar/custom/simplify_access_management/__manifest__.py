...

{
    ...
    'summary': """800_simplify_access_management_R_D_R16.0.1.0_31-5-2023

All In One Access Management +Rule +group
        """,
    ...
    'depends':['web','advanced_web_domain_widget','security_user_roles'],
