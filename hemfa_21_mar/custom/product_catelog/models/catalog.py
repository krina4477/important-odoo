...
class ProductCatalogMixin(models.AbstractModel):
    ...
    def action_add_from_catalog(self):
        kanban_view_id = self.env.ref('product_catelog.product_view_kanban_catalog').id
        search_view_id = self.env.ref('product_catelog.product_view_search_catalog').id
    ...
    def _get_product_catalog_order_line_info(self, product_ids, **kwargs):
        ...
        res = {product_id: {'productType': product_type} for product_id, product_type in result}
