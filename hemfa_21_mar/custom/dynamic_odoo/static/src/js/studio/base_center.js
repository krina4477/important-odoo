odoo.define('dynamic_odoo.BaseCenter', function (require) {
    ...
    var QWeb = core.qweb;
    const {Component, mount, onMounted, tags, utils} = owl;
    ...
    var BaseChooseView = base.WidgetBase.extend({
        ...
        init: function (parent, params) {
            ...
            this.vm = service.view;
            this.vmSt = service.viewSt;
            this.action_manager = service.action;
        },
        initParams: function () {
        ...
        renderNewApp: async function () {
            await mount(AppCenter, this.$el.find(".wgCon").empty()[0], {
                env: odoo['studio'].env,
                templates: templates,
