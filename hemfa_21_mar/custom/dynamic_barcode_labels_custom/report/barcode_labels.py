...
class ReportBarcodeLabelsCustom(models.AbstractModel):
    _name = 'report.dynamic_barcode_labels_custom.report_barcode_custom'
    ...
    def _get_barcode_string(self, product, data):
        barcode_value = product #product[str(data['form']['barcode_field'])]
