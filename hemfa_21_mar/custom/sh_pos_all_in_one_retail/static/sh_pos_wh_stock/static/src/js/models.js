            ...
            if(this.get_orderlines()){
                setTimeout(() => {
                    _.each(self.get_orderlines(),function(each_line){
                        ...
                        const qty_available = quant_by_product_id ? quant_by_product_id[self.pos.config.sh_pos_location[0]] : 0;
