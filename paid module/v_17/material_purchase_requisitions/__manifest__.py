...
- For more details please see Video on live preview or ask us by email...
    ...
    'depends': [
                ...
                'hr',
                'purchase',
                'odt_task_with_views', 'documents', 'sale', 'product','resource','bi_product_approval'
                ],
    'data':[
        ...
        'data/sale_requisition_sequence.xml',
        ...
        # 'views/price_list_migration_button.xml',
        'data/purchase_requisition_sla_cron.xml',
        'data/sale_requisition_sla_cron.xml',
        'data/purchase_order_cron.xml',
        'data/mail_data_sale.xml'
    ],
    'installable' : True,
    'application' : False,
}
