odoo.define('dynamic_odoo.AppCenter', function (require) {
    ...
    var BaseChooseView = base.WidgetBase.extend({
        ...
        init: function (parent, params) {
            ...
            this.menuService = this.props.menuService;
        },
        onStep: function (e) {
            e.stopPropagation();
            e.stopImmediatePropagation();
    ...
    class AppCenter extends Component {
        ...
        loadAppCenter() {
            const appCenter = new BaseChooseView(rootWidget, {menuService: this.menuService});
            appCenter.renderElement();
            $(this.__owl__.bdom.el).append(appCenter.$el);
        }
    }

    AppCenter.template = "studio.AppCenter";
