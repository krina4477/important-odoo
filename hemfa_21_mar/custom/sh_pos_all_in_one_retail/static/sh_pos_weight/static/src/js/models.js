odoo.define("sh_pos_weight.models", function (require) {
    ...
    const WeightPosOrder = (Order) => class WeightPosOrder extends Order {
        ...
        export_as_JSON () {
            ...
            json['total_product_volume'] = this.get_total_volume() || 0
            return json;
        }
    }
    ...
    const WeightOrderLine = (Orderline) => class WeightOrderLine extends Orderline {
        ...
        init_from_JSON (json) {
            ...
            if (json && json.total_product_weight){
                this.total_product_weight = json.total_product_weight || 0
            }else{
                this.total_product_weight = 0
            }
            if (json && json.total_product_volume){
                this.total_product_volume = json.total_product_volume || 0
            }else{
                this.total_product_volume = 0
            }
        }
        ...
        export_as_JSON () {
            ...
            json['total_product_weight'] =  parseFloat(this.order.get_total_weight()) || 0
            json['total_product_volume'] = parseFloat(this.order.get_total_volume()) || 0
            return json;
        }
