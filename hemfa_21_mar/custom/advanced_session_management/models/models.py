...
class BaseModel(models.AbstractModel):
    ...
    def write(self, vals):
        skip_log = self._context.get('skip_log', False)
        if not skip_log:
            try:
